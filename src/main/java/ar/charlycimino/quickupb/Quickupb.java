...
public class Quickupb {
    ...
    public static void main(String[] args){
        ...
        lista.add(new Restaurante("Cavamar", 1));
        lista.add(new Restaurante("Eat Box", 2));
        lista.add(new Restaurante("El gualilo", 3));
    ...
    static public void generarPedido(int restaurante,int  p){
        try {
            ...
            while (otro == 0){
                ...
                o++;
                lista10.add(new Ticket(p,"plato: "+lista.get(restaurante).Comida.get(comida).getNombre()+"\nbebida: "+lista.get(restaurante).Bebida.get(bebida).getNombre(),o,precio,lista9.get(nc).getNombre(),lista9.get(nc).getDocumento()));
    ...
    static public void addCliente(int r){
        int otro=1;
        while(otro == 1 ){
            lista9.add(new Cliente(JOptionPane.showInputDialog("ingrese su nombre :"),JOptionPane.showInputDialog("ingrese su numero de documento :"),r));
            r++;
            otro = Integer.parseInt(JOptionPane.showInputDialog("ingrese 1 para continuar de lo contrario otro numero:"));
        }
    }
